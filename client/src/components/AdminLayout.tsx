...
import { BarChart3, Home, List, LogOut, PlusCircle } from "lucide-react";
...
export default function AdminLayout({ children }: AdminLayoutProps) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f5f7f9]">
        <div className="text-center max-w-sm mx-auto p-8">
          <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663289350630/KxcFJasvLAobGPpE.png" alt="Home Grown Property Group" className="h-20 mx-auto mb-6" />
  ...
  return (
    <div className="flex min-h-screen bg-[#f5f7f9]">
      {/* Sidebar */}
      <aside className="w-64 flex-shrink-0 flex flex-col" style={{ backgroundColor: "#2A384C" }}>
        {/* Logo */}
        <div className="p-6 border-b border-[rgba(160,178,194,0.15)]">
          <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663289350630/lUoPAFTNBufcYnNy.png" alt="Home Grown Property Group" className="h-14 w-auto" />
        </div>
        ...
        <div className="p-4 border-t border-[rgba(160,178,194,0.15)]">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-full bg-[#A0B2C2] flex items-center justify-center text-[#2A384C] text-xs font-heading font-bold">
